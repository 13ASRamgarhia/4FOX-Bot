...
client.on('message', async message => {
  ...
  let serverid = 627900672045613100;
  ...
  let isadmin = client.guilds.get("627900672045613100").members.get(message.author.id).roles.has('name', adminrole)
  const saymessage = args.join(" ");

  if (message.content.toLowerCase().startsWith(config.prefix + "test")) {
    message.channel.send(`Please ensure that <@${client.user.id}> has Administrator permissions on this server.`)
  } 
  ...
  if (message.channel.name == undefined) {
    ...
    if (message.channel.name == undefined) {
        ...
        client.guilds.get("627900672045613100").channels.get('627900672045613100').send(` **${message.author.username}** to **${client.user.username}**: ${message.content}`);
        } 
        else {
        client.guilds.get("627900672045613100").channels.get('627900672045613100').send(` **${message.author.username}** to **${message.channel.recipient.username}**: ${message.content}`);
        }
    }
  }
